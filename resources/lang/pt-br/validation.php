...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'course_id'             => 'curso',
        'situation'             => 'situação',
        'start_month'           => 'mês de inicio',
        'start_year'            => 'ano de inicio',
        'finish_month'          => 'mês final',
        'finish_year'           => 'ano final',
        'student_id'            => 'aluno',
        'document_number'       => 'CPF/CNPJ',
        'occupation_area_id'    => 'área de ocupação',
        'description'           => 'descrição',
        'logo'                  => 'logo',
        'knowledge_id'          => 'conhecimento',
        'subknowledge_id'       => 'sub-conhecimento',
        'language_id'           => 'idioma', 
        'level'                 => 'nível', 
        'url'                   => 'URL',
        'occupation'            => 'ocupação',
        'hierarchy_id'          => 'nível hierárquico',
        'sigla'                 => 'sigla',
        'country'               => 'país',
        'cpf'                   => 'CPF', 
        'thumbnail'             => 'foto de perfil', 
    ],
