  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        ...
        <div class="col-sm-6">
          <button class="btn-header" onclick="window.location.href='{{route('admin.furnisher.create')}}'">Novo</button>
        </div>
      </div>
    </section>
        ...
        <section class="col-lg-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Lista de Prestadores de serviço</h3>
              <div class="box-tools">
                <?php
            ...
            <div class="box-body table-responsive">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  @forelse($furnishers as $furnisher)
                    <tr>
                      <td>{{$furnisher->name}}</td>
                      <td>{{$furnisher->email}}</td>
                      <td>{{$furnisher->occupation_area->name}}</td>
                      <td>
                      <a href="{{ route('admin.furnisher.status', ['furnisher' => $furnisher->id])}}"
                        ...
                        <a href="#" data-id="{{$furnisher->id}}"
                                            title="Alterar Senha" class="act-list act-list-blue act-password">
                                            <i class="fa fa-lock" aria-hidden="true"></i></i>
                                        </a>
                        <a href="{{ route('admin.furnisher.edit', ['furnisher' => $furnisher])}}" title="Editar" class="act-list act-list-blue">
                          <i class="fa fa-pencil-square" aria-hidden="true"></i>
                        </a>
                        <a href="{{ route('admin.furnisher.delete', ['furnisher' => $furnisher])}}" title="Excluir" class="act-list act-list-red act-delete">
...
<div class="modal fade" tabindex="-1" role="dialog" id="passwordModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.furnisher.password')}}" method="POST">
