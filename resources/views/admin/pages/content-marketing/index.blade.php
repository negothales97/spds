  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        ...
        <div class="col-sm-6">
          <button class="btn-header" onclick="window.location.href='{{route('admin.content-mkt.create')}}'">Novo</button>
        </div>
      </div>
    </section>
                  ...
                  @forelse($contents as $content)
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('admin.content-mkt.delete', ['content' => $content])}}" title="Excluir" class="act-list act-list-red act-delete">
