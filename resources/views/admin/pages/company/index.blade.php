  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        ...
        <div class="col-sm-6">
          <button class="btn-header" onclick="window.location.href='{{route('admin.company.create')}}'">Novo</button>
        </div>
      </div>
    </section>
                ...
                <tbody>
                  @forelse($companies as $company)
                    <tr>
                      ...
                      <td>{{$company->email}}</td>
                      <td>
                      <a href="{{ route('admin.company.status', ['company' => $company->id])}}"
                        ...
                        <a href="{{ route('admin.company.delete', ['company' => $company])}}" title="Excluir" class="act-list act-list-red act-delete">
