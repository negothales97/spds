        ...
        <div class="row">
            ...
            <section class="col-lg-12">
                <div class="box">
                    ...
                    <form method="POST" action="{{route('admin.service_provider.update')}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-4">
                                    ...
                                    <input type="text" name="document_number" placeholder="digite sem os pontos"
                                        class="form-control input-cpfcnpj" value="{{$provider->document_number}}">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    ...
                                    <select name="occupation_area_id" class="form-control">
                                        ...
                                        <option {{$occupation->id == $provider->occupation_area_id ? "selected" : ""}} value="{{$occupation->id}}">{{$occupation->name}}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="description" class="form-control" rows="5"
                                        placeholder="Fale um pouco sobre você">{{$provider->description}}</textarea>
                                </div>
                            </div>
                        </div>
