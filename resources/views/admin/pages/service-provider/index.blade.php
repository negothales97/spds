  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        ...
        <div class="col-sm-6">
          <button class="btn-header" onclick="window.location.href='{{route('admin.service_provider.create')}}'">Novo</button>
        </div>
      </div>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  @forelse($service_providers as $provider)
                    <tr>
                      <td>{{$provider->name}}</td>
                      <td>{{$provider->email}}</td>
                      <td>
                      <a href="{{ route('admin.service_provider.status', ['service_provider' => $provider->id])}}"
                        ...
                        <a href="{{ route('admin.service_provider.edit', ['service_provider' => $provider])}}" title="Editar" class="act-list act-list-blue">
                          <i class="fa fa-pencil-square" aria-hidden="true"></i>
                        </a>
                        <a href="{{ route('admin.service_provider.delete', ['service_provider' => $provider])}}" title="Excluir" class="act-list act-list-red act-delete">
