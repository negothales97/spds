...
@section('title', 'Ferramentas de Marketing')
...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        <div class="col-sm-6">
          <h1>Ferramentas de Marketing</h1>
        </div>
        <div class="col-sm-6">
          <button class="btn-header" onclick="window.location.href='{{route('admin.tools-mkt.create')}}'">Novo</button>
        </div>
      </div>
    </section>
                  ...
                  @forelse($tools as $tool)
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{ route('admin.tools-mkt.delete', ['tool' => $tool])}}" title="Excluir" class="act-list act-list-red act-delete">
