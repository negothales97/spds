  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="row">
        ...
        <div class="col-sm-6">
          <button class="btn-header" onclick="window.location.href='#'">Novo</button>
        </div>
      </div>
    </section>
                ...
                <tbody>
                  @forelse($admins as $admin)
                    <tr>
                      <td>{{$admin->name}}</td>
                      <td>{{$admin->email}}</td>
                      <td>@if($admin->admin_type == 1)Administrador @else Colaborador @endif</td>
                      <td>
                        <a href="{{ route('admin.admin.edit', ['id' => $admin->id])}}" title="edittar" class="act-list">
                          <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                        </a>
                        @if($admin->id !== 1)
                          <a href="{{ route('admin.admin.destroy', ['id' => $admin->id])}}" title="Excluir" class="act-list act-delete">
