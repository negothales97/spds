                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('admin.student.formation.delete', ['formation'=> $formation])}}"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('admin.student.professional.delete', ['professional'=> $professional])}}"
                                                        title="Editar" data-formation=""
                                                        class="act-list act-list-red act-delete">
                                                        <i class="fa f fa-trash" aria-hidden="true"></i>
                                                    </a>
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            @forelse($languages_student as $lang)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('admin.student.language.delete', ['language'=> $lang])}}"
                                                        title="Editar" data-formation=""
                                                        class="act-list act-list-red act-delete">
                                                        <i class="fa f fa-trash" aria-hidden="true"></i>
                                                    </a>
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            @forelse($knowledges_student as $know)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('admin.student.knowledge.delete', ['knowledge'=> $know])}}"
                                                        title="Editar" data-formation=""
                                                        class="act-list act-list-red act-delete">
                                                        <i class="fa f fa-trash" aria-hidden="true"></i>
                                                    </a>
...
<div class="modal fade" tabindex="-1" role="dialog" id="formationModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.student.formation.store')}}" method="POST">
...
<div class="modal fade" tabindex="-1" role="dialog" id="formationEditModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.student.formation.update')}}" method="POST">
                <div class="modal-body">
                    {{csrf_field()}}
...
<div class="modal fade" id="professionalModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{route('admin.student.professional.store')}}">
                <div class="modal-body">
                    {{csrf_field()}}
                    <input type="hidden" name="student_id" value="">
                    <div class="form-group row">
...
<div class="modal fade" id="professionalEditModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{route('admin.student.professional.update')}}">
                <div class="modal-body">
                    {{csrf_field()}}
...
<div class="modal fade" tabindex="-1" role="dialog" id="languageModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.student.language.store')}}" method="POST">
                <div class="modal-body">
                    {{csrf_field()}}
                    <input type="hidden" name="student_id" value="">
...
<div class="modal fade" tabindex="-1" role="dialog" id="languageEditModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.student.language.update')}}" method="POST">
                <div class="modal-body">
                    {{csrf_field()}}
...
<div class="modal fade" tabindex="-1" role="dialog" id="knowledgeModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.student.knowledge.store')}}" method="POST">
                <div class="modal-body">
                    {{csrf_field()}}
                    <input type="hidden" name="student_id" value="">
...
<div class="modal fade" tabindex="-1" role="dialog" id="knowledgeEditModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.student.knowledge.update')}}" method="POST">
                <div class="modal-body">
                    {{csrf_field()}}
