                ...
                <tbody>
                  @forelse($coupons as $coupon)
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('admin.coupon.edit', ['coupon' => $coupon])}}" title="Editar" class="act-list act-list-blue">
                          <i class="fa fa-pencil-square" aria-hidden="true"></i>
                        </a>
                        <a href="{{ route('admin.coupon.delete', ['coupon' => $coupon])}}" title="Excluir" class="act-list act-list-red act-delete">
